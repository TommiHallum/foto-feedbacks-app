...
# 2. CSS - KONSISTENT DESIGN (Upload-felt matcher knapper)
st.markdown("""
    <style>
    ...
    /* Skjul standard-tekst i uploader */
...
def create_pdf(img, exif, intro, s1, s2, s3, s4):
    ...
    # FOOTER I PDF (Byttet om på rækkefølgen)
    pdf.set_y(-30)
    pdf.set_font("Arial", 'B', 12)
    pdf.set_text_color(*brand_blue)
...
# 7. GRAFISK FOOTER (Byttet om på rækkefølgen som ønsket)
st.markdown("""
