...
# 2. CSS - ALLE RETTELSER (SIDEBAR, FLUGTNING, KNAPPER)
st.markdown("""
    <style>
    .stApp { background-color: #0e1117; color: #ffffff; }
    
    /* SIDEBAR: Maksimalt komprimeret som aftalt */
    ...
    /* HOVEDLAYOUT: Flugtning i bunden af de tre kolonner */
    [data-testid="column"] {
        display: flex;
    ...
    /* Knap styling - match til upload højde */
